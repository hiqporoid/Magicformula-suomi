...
3. Tilanne / virhe: Skillien kuvaukset olivat aluksi liian yleisiä, jolloin käyttötilanteet jäivät tulkinnanvaraisiksi.
   Korjaus: Lisättiin jokaiseen skilliin selkeät triggerit, projektikohtaiset tiedostokohdistukset sekä rajatut Tee/Vältä-säännöt.
   Uudelleenkäytettävä malli tai sääntö: Kirjaa jokaiseen repo-skilliin vähintään triggerit, kohdetiedostot ja eksplisiittiset rajaukset.
