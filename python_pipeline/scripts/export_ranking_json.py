...
def main() -> None:
    ...
    payload = {
        ...
        "financials_source": "python_pipeline/data/financials.csv",
        "data_sources": {
            "universe": {
                "label": "Nasdaq Helsinki Main Market -universe",
                "detail": "Universe ylläpidetään omana lähteenään Nasdaq Helsingin päälistan yhtiöille.",
                "path": "python_pipeline/data/main_market_universe.csv",
            },
            "financials": {
                "label": "Yahoo Finance -> financials.csv",
                "detail": "Talousluvut generoidaan Yahoo Financesta ja viedään staattiseen välitiedostoon ennen rankingia.",
                "path": "python_pipeline/data/financials.csv",
            },
        },
